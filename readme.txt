...
Get world-class support directly from developers. We prioritize helping you succeed at every stage.
[Contact now](https://www.ultimatebeaver.com/contact/)!

---

**Learn & Connect**

Access [170+ tutorials](https://www.ultimatebeaver.com/docs) for guidance. Join our [Facebook group](https://www.brainstormforce.com/go/uabb-facebook-group) to share ideas and connect with the community.

---

== Installation ==

1. Install via WordPress plugin directory or upload files to `wp-content/plugins`.
1. Activate and configure settings at Settings > Beaver Builder.
1. Access Page Builder from the Edit Page/Post area or the WordPress Admin Bar.
