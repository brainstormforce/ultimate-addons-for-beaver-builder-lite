					...
					'fields' => [
						...
						'icon_style'            => [
							...
							'toggle'  => [
								...
								'circle' => [
									'fields' => [ 'icon_color_preset', 'icon_bg_color', 'icon_bg_hover_color', 'icon_three_d' ],
								],
								'square' => [
									'fields' => [ 'icon_color_preset', 'icon_bg_color', 'icon_bg_hover_color', 'icon_three_d' ],
								],
								'custom' => [
									'fields' => [ 'icon_color_preset', 'icon_border_style', 'icon_bg_color', 'icon_bg_hover_color', 'icon_three_d', 'icon_bg_size', 'icon_bg_border_radius' ],
								],
							],
							'trigger' => [
								'custom' => [
