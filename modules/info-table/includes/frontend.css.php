...
if ( $settings->heading_font_family['family'] != "Default" || isset( $settings->heading_font_size['desktop'] ) && $settings->heading_font_size['desktop'] != '' || isset( $settings->heading_line_height['desktop'] ) && $settings->heading_line_height['desktop'] != '' || $settings->heading_font_size_unit != '' || $settings->heading_line_height_unit != ''|| $settings->heading_color != '' ) { ?>
	.fl-node-<?php echo $id;?> .info-table-heading .info-table-main-heading {
		...
		<?php if( !isset( $settings->heading_font_size_unit ) ) { ?>
				<?php if( isset( $settings->heading_font_size['desktop'] ) && $settings->heading_font_size['desktop'] != '' ) : ?>
		...
		<?php if( !isset( $settings->heading_line_height_unit ) ) { ?>
				<?php if( isset( $settings->heading_line_height['desktop'] ) && $settings->heading_line_height['desktop'] != '' ) : ?>
...
<?php }
if ( $settings->sub_heading_font_family['family'] != "Default" || isset( $settings->sub_heading_font_size['desktop'] ) && $settings->sub_heading_font_size['desktop'] != '' || isset( $settings->sub_heading_line_height['desktop'] ) && $settings->sub_heading_line_height['desktop'] != '' || $settings->sub_heading_font_size_unit != '' || $settings->sub_heading_line_height_unit != '' || $settings->sub_heading_color != '' ) { ?>
	.fl-node-<?php echo $id;?> .info-table-heading .info-table-sub-heading {
        ...
        <?php if( !isset( $settings->sub_heading_font_size_unit ) ) { ?>
				<?php if( isset( $settings->sub_heading_font_size['desktop'] ) && $settings->sub_heading_font_size['desktop'] != '' ) : ?>
		...
		<?php if( !isset( $settings->sub_heading_line_height_unit ) ) { ?>
				<?php if( isset( $settings->sub_heading_line_height['desktop'] ) && $settings->sub_heading_line_height['desktop'] != '' ) : ?>
...
if ( $settings->description_font_family['family'] != "Default" || isset( $settings->description_font_size['desktop'] ) && $settings->description_font_size['desktop'] != '' || isset( $settings->description_line_height['desktop'] ) && $settings->description_line_height['desktop'] != '' || $settings->description_font_size_unit != '' || $settings->description_line_height_unit != '' || $settings->description_color != '' ) { ?>
	.fl-node-<?php echo $id;?> .info-table .info-table-description {
		...
		<?php if( !isset( $settings->description_font_size_unit ) ) { ?>
				<?php if( isset( $settings->description_font_size['desktop'] ) && $settings->description_font_size['desktop'] != '' ) : ?>
...
if ( $settings->btn_font_family['family'] != "Default" || isset( $settings->btn_font_size['desktop'] ) && $settings->btn_font_size['desktop'] != '' || isset( $settings->btn_line_height['desktop'] ) && $settings->btn_line_height['desktop'] != '' || $settings->btn_font_size_unit != '' || $settings->btn_line_height_unit != '' ) { ?>
	.fl-node-<?php echo $id;?> .info-table-wrap .info-table-button a {
        ...
        <?php if( !isset( $settings->btn_font_size_unit ) ) { ?>
				<?php if( isset( $settings->btn_font_size['desktop'] ) && $settings->btn_font_size['desktop'] != '' ) : ?>
		...
		<?php if( !isset( $settings->btn_line_height_unit ) ) { ?>
				<?php if( isset( $settings->btn_line_height['desktop'] ) && $settings->btn_line_height['desktop'] != '' ) : ?>
...
if($global_settings->responsive_enabled) { // Global Setting If started 
		...
		@media ( max-width: <?php echo $global_settings->medium_breakpoint .'px'; ?> ) {
			<?php if( isset( $settings->heading_font_size['medium'] ) && $settings->heading_font_size['medium'] !="" || isset( $settings->heading_line_height['medium'] ) && $settings->heading_line_height['medium'] != "" || $settings->heading_font_size_unit_medium !="" || $settings->heading_line_height_unit_medium != "" ) { ?>
				.fl-node-<?php echo $id;?> .info-table-heading .info-table-main-heading {
					...
					<?php if( !isset( $settings->heading_line_height_unit_medium ) ) { ?>
						<?php if( isset( $settings->heading_line_height['medium'] ) && $settings->heading_line_height['medium'] != '' ) : ?>
			...
			<?php if( isset( $settings->sub_heading_font_size['medium'] ) && $settings->sub_heading_font_size['medium'] !="" || isset( $settings->sub_heading_line_height['medium'] ) && $settings->sub_heading_line_height['medium'] != "" || $settings->sub_heading_font_size_unit_medium !="" || $settings->sub_heading_line_height_unit_medium != "" ) { ?>
				.fl-node-<?php echo $id;?> .info-table-heading .info-table-sub-heading {
				    
				    <?php if( !isset( $settings->sub_heading_font_size_unit_medium ) ) { ?>
						<?php if( isset( $settings->sub_heading_font_size['medium'] ) && $settings->sub_heading_font_size['medium'] != '' ) : ?>
					...
					<?php if( !isset( $settings->sub_heading_line_height_unit_medium ) ) { ?>
						<?php if( isset( $settings->sub_heading_line_height['medium'] ) && $settings->sub_heading_line_height['medium'] != '' ) : ?>
			...
			<?php if( isset( $settings->description_font_size['medium'] ) && $settings->description_font_size['medium'] != "" || isset( $settings->description_line_height['medium'] ) && $settings->description_line_height['medium'] != "" || $settings->description_font_size_unit_medium != "" || $settings->description_line_height_unit_medium != "" ) { ?>
				.fl-node-<?php echo $id;?> .info-table .info-table-description {
					...
					<?php if( !isset( $settings->description_line_height_unit_medium ) ) { ?>
						<?php if( isset( $settings->description_line_height['medium'] ) && $settings->description_line_height['medium'] != '' ) : ?>
			...
			<?php if( isset( $settings->btn_font_size['medium'] ) && $settings->btn_font_size['medium'] !="" || isset( $settings->btn_line_height['medium'] ) && $settings->btn_line_height['medium'] != "" || $settings->btn_font_size_unit_medium !="" || $settings->btn_line_height_unit_medium != "" ) { ?>
				.fl-node-<?php echo $id;?> .info-table-wrap .info-table-button a {
				    <?php if( !isset( $settings->btn_font_size_unit_medium ) ) { ?>
						<?php if( isset( $settings->btn_font_size['medium'] ) && $settings->btn_font_size['medium'] != '' ) : ?>
					...
					<?php if( !isset( $settings->btn_line_height_unit_medium ) ) { ?>
						<?php if(isset(  $settings->btn_line_height['medium'] ) &&  $settings->btn_line_height['medium'] != '' ) : ?>
	...
	if( isset( $settings->heading_font_size['small'] ) && $settings->heading_font_size['small'] !="" || isset( $settings->heading_line_height['small'] ) && $settings->heading_line_height['small'] != "" || isset( $settings->sub_heading_font_size['small'] ) && $settings->sub_heading_font_size['small'] !="" || isset( $settings->sub_heading_line_height['small'] ) && $settings->sub_heading_line_height['small'] != "" || isset( $settings->description_font_size['small'] ) && $settings->description_font_size['small'] !="" || isset( $settings->description_line_height['small'] ) && $settings->description_line_height['small'] != "" || isset( $settings->btn_font_size['small'] ) && $settings->btn_font_size['small'] !="" || isset( $settings->btn_line_height['small'] ) && $settings->btn_line_height['small'] != "" || $settings->heading_font_size_unit_responsive !="" || $settings->heading_line_height_unit_responsive != "" || $settings->sub_heading_font_size_unit_responsive !="" || $settings->sub_heading_line_height_unit_responsive != "" || $settings->description_font_size_unit_responsive !="" || $settings->description_line_height_unit_responsive != "" || $settings->btn_font_size_unit_responsive !="" || $settings->btn_line_height_unit_responsive != "" ) {
	?>
		@media ( max-width: <?php echo $global_settings->responsive_breakpoint .'px'; ?> ) {
			<?php if( isset( $settings->heading_font_size['small'] ) && $settings->heading_font_size['small'] !="" || isset( $settings->heading_line_height['small'] ) && $settings->heading_line_height['small'] != "" || $settings->heading_font_size_unit_responsive !="" || $settings->heading_line_height_unit_responsive != "" ) { ?>
				.fl-node-<?php echo $id;?> .info-table-heading .info-table-main-heading {
			...
			<?php if( isset( $settings->sub_heading_font_size['small'] ) && $settings->sub_heading_font_size['small'] !="" || isset( $settings->sub_heading_line_height['small'] ) && $settings->sub_heading_line_height['small'] != "" || $settings->sub_heading_font_size_unit_responsive !="" || $settings->sub_heading_line_height_unit_responsive != "" ) { ?>
				.fl-node-<?php echo $id;?> .info-table-heading .info-table-sub-heading {
                    
                    <?php if( !isset( $settings->sub_heading_font_size_unit_responsive ) ) { ?>
						<?php if( isset( $settings->sub_heading_font_size['small'] ) && $settings->sub_heading_font_size['small'] != '' ) : ?>
                    ...
                    <?php if( !isset( $settings->sub_heading_line_height_unit_responsive ) ) { ?>
						<?php if( isset( $settings->sub_heading_line_height['small'] ) && $settings->sub_heading_line_height['small'] != '' ) : ?>
			...
			<?php if( isset( $settings->description_font_size['small'] ) && $settings->description_font_size['small'] != "" || isset( $settings->description_line_height['small'] ) && $settings->description_line_height['small'] != "" || $settings->description_font_size_unit_responsive != "" || $settings->description_line_height_unit_responsive != "" ) { ?>
				.fl-node-<?php echo $id;?> .info-table .info-table-description {
                    ...
                    <?php if( !isset( $settings->description_line_height_unit_responsive ) ) { ?>
						<?php if( isset( $settings->description_line_height['small'] ) && $settings->description_line_height['small'] != '' ) : ?>
			...
			<?php if( isset( $settings->btn_font_size['small'] ) && $settings->btn_font_size['small'] !="" || isset( $settings->btn_line_height['small'] ) && $settings->btn_line_height['small'] != "" || $settings->btn_font_size_unit_responsive !="" || $settings->btn_line_height_unit_responsive != "" ) { ?>
				.fl-node-<?php echo $id;?> .info-table-wrap .info-table-button a {
					
					<?php if( !isset( $settings->btn_font_size_unit_responsive ) ) { ?>
						<?php if( isset( $settings->btn_font_size['small'] ) && $settings->btn_font_size['small'] != '' ) : ?>
					...
					<?php if( !isset( $settings->btn_line_height_unit_responsive ) ) { ?>
						<?php if( isset( $settings->btn_line_height['small'] ) && $settings->btn_line_height['small'] != '' ) : ?>
