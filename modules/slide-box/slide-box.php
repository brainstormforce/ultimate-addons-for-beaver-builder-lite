    ...
    function render_new_data( $data ) {
        ...
        foreach ( $data as &$node ) {
            ...
            if ( isset( $node->settings->type ) && 'slide-box' === $node->settings->type ) {
                ...
                if ( is_numeric( $node->settings->front_title_line_height['small']) && is_numeric( $node->settings->front_title_font_size['small']) && $node->settings->front_title_font_size['small'] != 0 && !isset( $node->settings->front_title_line_height_unit_responsive ) ) {
                ...
                if( is_numeric( $node->settings->front_title_line_height['medium']) && is_numeric( $node->settings->front_title_font_size['medium']) && $node->settings->front_title_font_size['medium'] != 0 && !isset( $node->settings->front_title_line_height_unit_medium ) ) {
                ...
                if( is_numeric( $node->settings->front_title_line_height['desktop']) && is_numeric( $node->settings->front_title_font_size['desktop']) && $node->settings->front_title_font_size['desktop'] != 0 && !isset( $node->settings->front_title_line_height_unit ) ) {
                ...
                if ( is_numeric( $node->settings->front_desc_line_height['small']) && is_numeric( $node->settings->front_desc_font_size['small']) && $node->settings->front_desc_font_size['small'] != 0 && !isset( $node->settings->front_desc_line_height_unit_responsive ) ) {
                ...
                if( is_numeric( $node->settings->front_desc_line_height['medium']) && is_numeric( $node->settings->front_desc_font_size['medium']) && $node->settings->front_desc_font_size['medium'] != 0 && !isset( $node->settings->front_desc_line_height_unit_medium ) ) {
                ...
                if( is_numeric( $node->settings->front_desc_line_height['desktop']) && is_numeric( $node->settings->front_desc_font_size['desktop']) && $node->settings->front_desc_font_size['desktop'] != 0 && !isset( $node->settings->front_desc_line_height_unit ) ) {
                ...
                if ( is_numeric( $node->settings->back_title_line_height['small']) && is_numeric( $node->settings->back_title_font_size['small']) && $node->settings->back_title_font_size['small'] != 0 && !isset( $node->settings->back_title_line_height_unit_responsive ) ) {
                ...
                if( is_numeric( $node->settings->back_title_line_height['medium']) && is_numeric( $node->settings->back_title_font_size['medium']) && $node->settings->back_title_font_size['medium'] != 0 && !isset( $node->settings->back_title_line_height_unit_medium ) ) {
                ...
                if( is_numeric( $node->settings->back_title_line_height['desktop']) && is_numeric( $node->settings->back_title_font_size['desktop']) && $node->settings->back_title_font_size['desktop'] != 0 && !isset( $node->settings->back_title_line_height_unit ) ) {
                ...
                if ( is_numeric( $node->settings->back_desc_line_height['small']) && is_numeric( $node->settings->back_desc_font_size['small']) && $node->settings->back_desc_font_size['small'] != 0 &&!isset( $node->settings->back_desc_line_height_unit_responsive ) ) {
                ...
                if( is_numeric( $node->settings->back_desc_line_height['medium']) && is_numeric( $node->settings->back_desc_font_size['medium']) && $node->settings->back_desc_font_size['medium'] != 0 &&!isset( $node->settings->back_desc_line_height_unit_medium ) ) {
                ...
                if( is_numeric( $node->settings->back_desc_line_height['desktop']) && is_numeric( $node->settings->back_desc_font_size['desktop']) && $node->settings->back_desc_font_size['desktop'] != 0 &&!isset( $node->settings->back_desc_line_height_unit ) ) {
                ...
                if ( is_numeric( $node->settings->link_line_height['small']) && is_numeric( $node->settings->link_font_size['small']) && $node->settings->link_font_size['small'] != 0 &&!isset( $node->settings->link_line_height_unit_responsive ) ) {
                    $node->settings->link_line_height_unit_responsive = $node->settings->link_line_height['small'] / $node->settings->link_font_size['small'];
                }
                if( is_numeric( $node->settings->link_line_height['medium']) && is_numeric( $node->settings->link_font_size['medium']) && $node->settings->link_font_size['medium'] != 0 &&!isset( $node->settings->link_line_height_unit_medium ) ) {
                    $node->settings->link_line_height_unit_medium = $node->settings->link_line_height['medium'] / $node->settings->link_font_size['medium'];
                }
                if( is_numeric( $node->settings->link_line_height['desktop']) && is_numeric( $node->settings->link_font_size['desktop']) && $node->settings->link_font_size['desktop'] != 0 &&!isset( $node->settings->link_line_height_unit ) ) {
