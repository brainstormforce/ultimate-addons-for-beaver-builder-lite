...
.fl-node-<?php echo $id; ?> .uabb-slide-box .uabb-slide-face-text-title {
    ...
    <?php if( !isset( $settings->front_title_font_size_unit ) ) { ?>
        <?php if( isset( $settings->front_title_font_size['desktop'] ) && $settings->front_title_font_size['desktop'] != '' ) : ?>
    ...
    <?php if( !isset( $settings->front_title_line_height_unit ) ) { ?>
        <?php if( isset( $settings->front_title_line_height['desktop'] ) && $settings->front_title_line_height['desktop'] != '' ) : ?>
...
.fl-node-<?php echo $id; ?> .uabb-slide-box .uabb-slide-box-section-content {
    ...
    <?php if( !isset( $settings->front_desc_font_size_unit ) ) { ?>
        <?php if( isset( $settings->front_desc_font_size['desktop'] ) && $settings->front_desc_font_size['desktop'] != '' ) : ?>
    ...
    <?php if( !isset( $settings->front_desc_line_height_unit ) ) { ?>
        <?php if( isset( $settings->front_desc_line_height['desktop'] ) && $settings->front_desc_line_height['desktop'] != '' ) : ?>
...
.fl-node-<?php echo $id; ?> .uabb-slide-box .uabb-slide-back-text-title {
    ...
    <?php if( !isset( $settings->back_title_font_size_unit ) ) { ?>
        <?php if( isset( $settings->back_title_font_size['desktop'] ) && $settings->back_title_font_size['desktop'] != '' ) : ?>
    ...
    <?php if( !isset( $settings->back_title_line_height_unit ) ) { ?>
        <?php if( isset( $settings->back_title_line_height['desktop'] ) && $settings->back_title_line_height['desktop'] != '' ) : ?>
...
.fl-node-<?php echo $id; ?> .uabb-slide-box .uabb-slide-down-box-section-content {
    ...
    <?php if( !isset( $settings->back_desc_font_size_unit ) ) { ?>
        <?php if( isset( $settings->back_desc_font_size['desktop'] ) && $settings->back_desc_font_size['desktop'] != '' ) : ?>
    ...
    <?php if( !isset( $settings->back_desc_line_height_unit ) ) { ?>
        <?php if( isset( $settings->back_desc_line_height['desktop'] ) && $settings->back_desc_line_height['desktop'] != '' ) : ?>
...
.fl-builder-content .fl-node-<?php echo $id; ?> .uabb-callout-cta-link {
    ...
    <?php if( !isset( $settings->link_font_size_unit ) ) { ?>
        <?php if( isset( $settings->link_font_size['desktop'] ) && $settings->link_font_size['desktop'] != '' ) : ?>
    ...
    <?php if( !isset( $settings->link_line_height_unit ) ) { ?>
        <?php if( isset( $settings->link_line_height['desktop'] ) && $settings->link_line_height['desktop'] != '' ) : ?>
...
?>
    @media ( max-width: <?php echo $global_settings->medium_breakpoint; ?>px ) {
        ...
        .fl-node-<?php echo $id; ?> .uabb-slide-box .uabb-slide-box-section-content {
                ...
                <?php if( !isset( $settings->front_desc_font_size_unit_medium ) ) { ?>
                    <?php if( isset( $settings->front_desc_font_size['medium'] ) && $settings->front_desc_font_size['medium'] != '' ) : ?>
                ...
                <?php if( !isset( $settings->front_desc_line_height_unit_medium ) ) { ?>
                        <?php if( isset( $settings->front_desc_line_height['medium'] ) && $settings->front_desc_line_height['medium'] != '' ) : ?>
        ...
        .fl-node-<?php echo $id; ?> .uabb-slide-box .uabb-slide-face-text-title {
            <?php if( !isset( $settings->front_title_font_size_unit_medium ) ) { ?>
                <?php if( isset( $settings->front_title_font_size['medium'] ) && $settings->front_title_font_size['medium'] != '' ) : ?>
            ...
            <?php if( !isset( $settings->front_title_line_height_unit_medium ) ) { ?>
                    <?php if( isset( $settings->front_title_line_height['medium'] ) && $settings->front_title_line_height['medium'] != '' ) : ?>
        ...
        .fl-node-<?php echo $id; ?> .uabb-slide-box .uabb-slide-down-box-section-content {
            <?php if( !isset( $settings->back_desc_font_size_unit_medium ) ) { ?>
                <?php if( isset( $settings->back_desc_font_size['medium'] ) && $settings->back_desc_font_size['medium'] != '' ) : ?>
            ...
            <?php if( !isset( $settings->back_desc_line_height_unit_medium ) ) { ?>
                    <?php if( isset( $settings->back_desc_line_height['medium'] ) && $settings->back_desc_line_height['medium'] != '' ) : ?>
        ...
        .fl-node-<?php echo $id; ?> .uabb-slide-box .uabb-slide-back-text-title {
            <?php if( !isset( $settings->back_title_font_size_unit_medium ) ) { ?>
                <?php if( isset( $settings->back_title_font_size['medium'] ) && $settings->back_title_font_size['medium'] != '' ) : ?>
            ...
            <?php if( !isset( $settings->back_title_line_height_unit_medium ) ) { ?>
                    <?php if( isset( $settings->back_title_line_height['medium'] ) && $settings->back_title_line_height['medium'] != '' ) : ?>
        ...
        .fl-builder-content .fl-node-<?php echo $id; ?> .uabb-callout-cta-link {
            <?php if( !isset( $settings->link_font_size_unit_medium ) ) { ?>
                <?php if( isset( $settings->link_font_size['medium'] ) && $settings->link_font_size['medium'] != '' ) : ?>
            ...
            <?php if( !isset( $settings->link_line_height_unit_medium ) ) { ?>
                    <?php if( isset( $settings->link_line_height['medium'] ) && $settings->link_line_height['medium'] != '' ) : ?>
     ...
     @media ( max-width: <?php echo $global_settings->responsive_breakpoint; ?>px ) {
        ...
        .fl-node-<?php echo $id; ?> .uabb-slide-box .uabb-slide-box-section-content {
            <?php if( !isset( $settings->front_desc_font_size_unit_responsive ) ) { ?>
                <?php if( isset( $settings->front_desc_font_size['small'] ) && $settings->front_desc_font_size['small'] != '' ) : ?>
            ...
            <?php if( !isset( $settings->front_desc_line_height_unit_responsive ) ) { ?>
                <?php if( isset( $settings->front_desc_line_height['small'] ) && $settings->front_desc_line_height['small'] != '' ) : ?>
        ...
        .fl-node-<?php echo $id; ?> .uabb-slide-box .uabb-slide-face-text-title {
            <?php if( !isset( $settings->front_title_font_size_unit_responsive ) ) { ?>
                <?php if( isset( $settings->front_title_font_size['small'] ) && $settings->front_title_font_size['small'] != '' ) : ?>
            ...
            <?php if( !isset( $settings->front_title_line_height_unit_responsive ) ) { ?>
                <?php if( isset( $settings->front_title_line_height['small'] ) && $settings->front_title_line_height['small'] != '' ) : ?>
        ...
        .fl-node-<?php echo $id; ?> .uabb-slide-box .uabb-slide-down-box-section-content {
            <?php if( !isset( $settings->back_desc_font_size_unit_responsive ) ) { ?>
                <?php if( isset( $settings->back_desc_font_size['small'] ) && $settings->back_desc_font_size['small'] != '' ) : ?>
            ...
            <?php if( !isset( $settings->back_desc_line_height_unit_responsive ) ) { ?>
                <?php if( isset( $settings->back_desc_line_height['small'] ) && $settings->back_desc_line_height['small'] != '' ) : ?>
        ...
        .fl-node-<?php echo $id; ?> .uabb-slide-box .uabb-slide-back-text-title {
            <?php if( !isset( $settings->back_title_font_size_unit_responsive ) ) { ?>
                <?php if( isset( $settings->back_title_font_size['small'] ) && $settings->back_title_font_size['small'] != '' ) : ?>
            ...
            <?php if( !isset( $settings->back_title_line_height_unit_responsive ) ) { ?>
                <?php if( isset( $settings->back_title_line_height['small'] ) && $settings->back_title_line_height['small'] != '' ) : ?>
        ...
        .fl-builder-content .fl-node-<?php echo $id; ?> .uabb-callout-cta-link {
            <?php if( !isset( $settings->link_font_size_unit_responsive ) ) { ?>
                <?php if( isset( $settings->link_font_size['small'] ) && $settings->link_font_size['small'] != '' ) : ?>
            ...
            <?php if( !isset( $settings->link_line_height_unit_responsive ) ) { ?>
                <?php if( isset( $settings->link_line_height['small'] ) && $settings->link_line_height['small'] != '' ) : ?>
