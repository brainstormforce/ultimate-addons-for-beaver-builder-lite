					...
					'fields' => [
						...
						'image_style'  => [
							...
							'toggle'  => [
								...
								'custom' => [
									'sections' => [ 'img_colors' ],
									'fields'   => [ 'img_bg_size', 'img_bg_color' ],
								],
							],
							'trigger' => [
								'custom' => [
				...
				'img_icon_styles' => [ // Section.
					...
					'fields' => [ // Section Fields.
						...
						'front_icon_border'             => [
							...
							'toggle'  => [
								'yes' => [
									'fields' => [ 'front_icon_border_size', 'front_icon_border_color', 'front_icon_border_hover_color' ],
								],
							],
						],
					...
					'fields' => [ // Section Fields.
						'slide_type' => [
							...
							'toggle'  => [
								...
								'style2' => [
									'fields'   => [ 'focused_front_title_color', 'focused_front_desc_color', 'dropdown_icon_bg_color', 'dropdown_icon_color' ],
					...
					'fields' => [ // Section Fields.
						'overlay'                   => [
							...
							'toggle'  => [
								...
								'yes' => [
									'fields' => [ 'overlay_color', 'overlay_opacity', 'overlay_icon', 'overlay_icon_color', 'overlay_icon_bg_color', 'overlay_icon_bg_color_opc', 'overlay_icon_size' ],
								],
							],
						],
						'overlay_color'             => [
